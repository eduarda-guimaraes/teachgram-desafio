...
export const AuthPage = ({ initialMode = 'login', onAuthenticated }: AuthPageProps) => {
  return (
    <main className="auth-page container-fluid min-vh-100 p-3 p-md-4">
        ...
        <div className="col-12 col-xxl-10">
          <div className="auth-card card border-0 shadow-sm overflow-hidden rounded-4">
            <div className="auth-content row g-0">
              <div className="auth-form-panel col-12 col-lg-5 col-xl-4 order-2 order-lg-1 d-flex align-items-center">
                <LoginForm initialMode={initialMode} onAuthenticated={onAuthenticated} />
              </div>
              <div className="auth-illustration col-12 col-lg-7 col-xl-8 order-1 order-lg-2 position-relative">
